...
#define SERVO_MIN_PULSEWIDTH_US (1000) // Minimum pulse width in microsecond (us)
#define SERVO_MAX_PULSEWIDTH_US (2000) // Maximum pulse width in microsecond (us)
...
// void app_main(void)
void task_test_sg90(void *ignore)
{    
    init_sg90_pwm();
